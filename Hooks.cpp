...
namespace Hooks
{
	...
	void Initialise()
	{
		...
		draw.fonts.secondarytabs = m_pSurface->FontCreate();
		m_pSurface->SetFontGlyphSet(draw.fonts.secondarytabs, XorStr("Impact"), 12, 400, 0, 0, (int)FONTFLAG_ANTIALIAS);
		...
		m_pSurface->SetFontGlyphSet(draw.fonts.font_icons, XorStr("Impact"), 32, 400, 0, 0, (int)FONTFLAG_ANTIALIAS | (int)FONTFLAG_OUTLINE);
