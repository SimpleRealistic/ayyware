...
void Settings::Update( )
{
	...
	//Hitscan
	hitscanconfig.hitboxes = Menu::Window.HitscanTab.HitscanBones.items;
	...
	resolverconfig.bLowerbodyIndicator = Menu::Window.VisualsTab.LowerbodyIndicator.GetState( );
	...
	visualconfig.player.cGlowRed = Menu::Window.VisualsTab.player.GlowR.GetValue( );
	visualconfig.player.cGlowGreen = Menu::Window.VisualsTab.player.GlowG.GetValue( );
	visualconfig.player.cGlowBlue = Menu::Window.VisualsTab.player.GlowB.GetValue( );
